...
const AsyncHomePage = loadable<{ page: string }>(() => import('./home'), {
	fallback: <div>Loading...</div>,
})
const AsyncAboutPage = loadable<{ page: string }>(() => import('./about'), {
	fallback: <div>Loading...</div>,
})
const AsyncMorePage = loadable<{ page: string }>((props) => import('./more'), {
	fallback: <div>Loading...</div>,
})
